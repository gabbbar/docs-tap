...
#### <a id='1-7-3-scst-store-ri'></a> v1.7.3 Resolved issues: Supply Chain Security Tools - Store
...
#### <a id='1-7-3-bitnami-services-ki'></a> v1.7.3 Known issues: Bitnami Services
...
#### <a id='1-7-3-convention-ki'></a> v1.7.3 Known issues: Cartographer Conventions
...
#### <a id='1-7-3-svc-bindings-ki'></a> v1.7.3 Known issues: Service Bindings
...
#### <a id='1-7-3-stk-ki'></a> v1.7.3 Known issues: Services Toolkit
...
#### <a id='1-7-3-scc-ki'></a> v1.7.3 Known issues: Supply Chain Choreographer
...
#### <a id='1-7-3-tdp-ki'></a> v1.7.3 Known issues: Tanzu Developer Portal
...
#### <a id='1-7-3-vs-plugin-ki'></a> v1.7.3 Known issues: Tanzu Developer Tools for Visual Studio
...
#### <a id='1-7-1-tap-ri'></a> v1.7.1 Resolved issues: Tanzu Application Platform

- Tanzu Application Platform v1.7.1 is supported with Tanzu Kubernetes releases (TKR) v1.26 on
  vSphere with Tanzu v8.

#### <a id='1-7-1-scc-ri'></a> v1.7.1 Resolved issues: Supply Chain Choreographer
